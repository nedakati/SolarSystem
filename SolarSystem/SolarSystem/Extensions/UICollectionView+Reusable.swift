...
extension UICollectionView {
    ...
    func register<T: UICollectionViewCell>(cellType: T.Type) where T: NibRepresentable {
    ...
    func register<T: UICollectionReusableView>(supplementaryViewType: T.Type, ofKind elementKind: String) where T: NibRepresentable {
